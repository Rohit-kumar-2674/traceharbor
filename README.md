...
Open the private `http://127.0.0.1:8742/#token=…` link printed in your terminal.
...
Do not delete the SQLite database or `originals/` folder to "fix" an integrity error.
...
collect, access or disclose data. "TraceHarbor" is a working project name; no trademark
